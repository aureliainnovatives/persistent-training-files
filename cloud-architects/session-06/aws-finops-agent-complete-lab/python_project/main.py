"""AgentCore Harness client for the AWS FinOps Agent lab."""
...
from finops_tools import execute_tool
...
def run(prompt):
    ...
    for number in range(1, 21):
        ...
        print("\n\n" + "=" * 72)
        print(f"INLINE FINOPS TOOL REQUEST #{number}")
        print(f"Function: {name}")
        print(json.dumps(arguments, indent=2))

        result = execute_tool(name, arguments)

        print("\nLOCAL FINOPS TOOL RESULT:")
